...
const Board = () => {
  ...
  const favouriteLists = useSelector((state) => state.favourites.value)
  ...
  const onIconChange = async (newIcon) => {
    ...
    if(isFavourite) {
      let tempFavourite = [...favouriteLists]
  ...
  const deleteBoard = async () => {
    try {
      ...
      if (isFavourite) {
        const newFavouriteList = favouriteLists.filter(e => e.id !== boardId)
  ...
  const ToggleFavourite = async () => {
    try {
      ...
      let newFavouriteList = [...favouriteLists]
      if(isFavourite)
      {
  ...
  return (
    ...
    <Box sx={{
      ...
      <IconButton variant='outlined' onClick={ToggleFavourite}>
        {
          isFavourite ? (
